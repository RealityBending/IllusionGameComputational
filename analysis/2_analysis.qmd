...
gam_lnr_muller <- readRDS(paste0(path, "m_lnr_muller_1.rds"))
```
...
pred <- rbind(
  # GAM
  rbind(
    estimate_relation(gam_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 15), predict = "mu") |> 
      mutate(Parameter = "Nu_Correct", Type = "GAM"),
    estimate_relation(gam_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 15), predict = "nuone") |> 
      mutate(Parameter = "Nu_Error", Type = "GAM"),
    estimate_relation(gam_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 15), predict = "sigmazero") |> 
      mutate(Parameter = "Sigma_Correct", Type = "GAM"),
    estimate_relation(gam_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 15), predict = "sigmaone") |> 
      mutate(Parameter = "Sigma_Error", Type = "GAM"),
    estimate_relation(gam_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 15), predict = "ndt") |> 
      mutate(Parameter = "NDT", Type = "GAM")
  ),
  # LM
  rbind(
    estimate_relation(m1_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 10), predict = "mu") |> 
      mutate(Parameter = "Nu_Correct", Type = "LM"),
    estimate_relation(m1_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 10), predict = "nuone") |> 
      mutate(Parameter = "Nu_Error", Type = "LM"),
    estimate_relation(m1_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 10), predict = "sigmazero") |> 
      mutate(Parameter = "Sigma_Correct", Type = "LM"),
    estimate_relation(m1_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 10), predict = "sigmaone") |> 
      mutate(Parameter = "Sigma_Error", Type = "LM"),
    estimate_relation(m1_lnr_muller, length = c(Illusion_DifferenceZ = 4, Illusion_StrengthZ = 10), predict = "ndt") |> 
      mutate(Parameter = "NDT", Type = "LM") 
  ) |> 
    filter((Illusion_Effect == "Conflicting" & Illusion_DifferenceZ >= 0) | 
             (Illusion_Effect == "Facilitating" & Illusion_DifferenceZ < 0)) |> 
    select(-Illusion_Effect)
) |> 
...
pred |> 
  ...
  geom_line(aes(color = Illusion_Difference, group = interaction(Type, Illusion_Difference), linetype = Type),
            linewidth = 1.5) +
  scale_color_manual(values = c("#FF5722", "#FFC107", "#8BC34A", "#4CAF50")) +
