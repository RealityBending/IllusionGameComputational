...
(illu |> 
  ggplot() +
  geom_histogram(aes(x = Illusion_Strength), bins = 101) +
  facet_grid(~Illusion_Type, scales = "free") +
  scale_x_continuous(n.breaks = 10) +
  theme_minimal()) / 
  (illu |> 
  ggplot() +
  geom_histogram(aes(x = Illusion_Difference), bins = 101) +
  facet_grid(~Illusion_Type, scales = "free") +
  scale_x_continuous(n.breaks = 10) +
  theme_minimal())
```
