...
```{r}
illu <- rbind(illu_reliability, illu_suggestibility, illu_pcs)
...
cols <- c("IllusionGameSuggestibility" = "#9C27B0", "IllusionGameReliability" = "#FF9800", "IllusionGamePCS" = "#FFC0CB")
binwidth <- 0.03
...
write.csv(illu[400001:nrow(illu), ], "../data/illusion_part2.csv", row.names = FALSE)
