...
```{r}
pred_isi <- mgcv::bam(RT ~ Illusion_Type + s(ISI, k = -1, by = `Illusion_Type`, bs = "cr"),
                   data = illu |> 
...
```{r}
pred_isi <- mgcv::bam(Error ~ Illusion_Type + s(ISI, k = -1, by = `Illusion_Type`, bs = "cr"),
